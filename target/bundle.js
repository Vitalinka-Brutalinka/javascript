var gatling = (() => {
  ...
  // node_modules/@gatling.io/cli/polyfills/globals.js
  var import_buffer, crypto;
  var init_globals = __esm({
    "node_modules/@gatling.io/cli/polyfills/globals.js"() {
      import_buffer = __require("buffer");
      crypto = __toESM(__require("crypto"));
    }
  });
  ...
  var require_jvm_types = __commonJS({
    "node_modules/@gatling.io/jvm-types/index.js"(exports) {
      ...
      exports.Binary$TypedCondition = Java.type("io.gatling.javaapi.http.WsFrameCheck$Binary$TypedCondition");
      exports.Binary$UntypedCondition = Java.type("io.gatling.javaapi.http.WsFrameCheck$Binary$UntypedCondition");
      ...
      exports.ConnectActionBuilder = Java.type("io.gatling.javaapi.mqtt.ConnectActionBuilder");
      ...
      exports.DummyBuilder = Java.type("io.gatling.javaapi.core.DummyBuilder");
      ...
      exports.MqttInboundMessage = Java.type("io.gatling.mqtt.action.MqttInboundMessage");
      exports.MqttMessageType = Java.type("io.netty.handler.codec.mqtt.MqttMessageType");
      exports.MqttProperties = Java.type("io.netty.handler.codec.mqtt.MqttProperties");
      exports.MqttProtocolBuilder = Java.type("io.gatling.javaapi.mqtt.MqttProtocolBuilder");
      exports.MqttPublishVariableHeader = Java.type("io.netty.handler.codec.mqtt.MqttPublishVariableHeader");
      exports.MqttQoS = Java.type("io.netty.handler.codec.mqtt.MqttQoS");
      exports.Mqtt = Java.type("io.gatling.javaapi.mqtt.Mqtt");
      ...
      exports.PublishActionBuilder$Base = Java.type("io.gatling.javaapi.mqtt.PublishActionBuilder$Base");
      exports.PublishActionBuilder$Checkable = Java.type("io.gatling.javaapi.mqtt.PublishActionBuilder$Checkable");
      exports.PublishActionBuilder = Java.type("io.gatling.javaapi.mqtt.PublishActionBuilder");
      ...
      exports.RequestActionBuilder = Java.type("io.gatling.javaapi.http.RequestActionBuilder");
      ...
      exports.RequestWithBodyActionBuilder = Java.type("io.gatling.javaapi.http.RequestWithBodyActionBuilder");
      ...
      exports.Sse$Prefix = Java.type("io.gatling.javaapi.http.Sse$Prefix");
      exports.SseAwaitActionBuilder$On = Java.type("io.gatling.javaapi.http.SseAwaitActionBuilder$On");
      ...
      exports.SseMessageCheck$TypedCondition = Java.type("io.gatling.javaapi.http.SseMessageCheck$TypedCondition");
      exports.SseMessageCheck$UntypedCondition = Java.type("io.gatling.javaapi.http.SseMessageCheck$UntypedCondition");
      ...
      exports.SubscribeActionBuilder$Checkable = Java.type("io.gatling.javaapi.mqtt.SubscribeActionBuilder$Checkable");
      exports.SubscribeActionBuilder = Java.type("io.gatling.javaapi.mqtt.SubscribeActionBuilder");
      exports.System = Java.type("java.lang.System");
      exports.TemporalUnit = Java.type("java.time.temporal.TemporalUnit");
      exports.Text$TypedCondition = Java.type("io.gatling.javaapi.http.WsFrameCheck$Text$TypedCondition");
      exports.Text$UntypedCondition = Java.type("io.gatling.javaapi.http.WsFrameCheck$Text$UntypedCondition");
      ...
      exports.WaitForMessagesActionBuilder = Java.type("io.gatling.javaapi.mqtt.WaitForMessagesActionBuilder");
      ...
      exports.Ws$Prefix = Java.type("io.gatling.javaapi.http.Ws$Prefix");
      exports.WsAwaitActionBuilder$On = Java.type("io.gatling.javaapi.http.WsAwaitActionBuilder$On");
      exports.WsAwaitActionBuilder = Java.type("io.gatling.javaapi.http.WsAwaitActionBuilder");
      exports.WsConnectActionBuilder = Java.type("io.gatling.javaapi.http.WsConnectActionBuilder");
      exports.WsFrameCheck$Binary = Java.type("io.gatling.javaapi.http.WsFrameCheck$Binary");
      exports.WsFrameCheck$Text = Java.type("io.gatling.javaapi.http.WsFrameCheck$Text");
  ...
  var require_session = __commonJS({
    "node_modules/@gatling.io/core/target/session.js"(exports) {
      ...
      var underlyingBiSessionTransform = (f) => (jvmMain, jvmForked) => f((0, exports.wrapSession)(jvmMain), (0, exports.wrapSession)(jvmForked))._underlying;
      ...
      var isSessionTo = (value) => typeof value === "function";
      ...
      var underlyingXWithSessionToSession = (f) => (x, jvmSession) => f(x, (0, exports.wrapSession)(jvmSession))._underlying;
      exports.underlyingXWithSessionToSession = underlyingXWithSessionToSession;
      var underlyingJvmXToXWithSessionToSession = (f, wrap) => (jvmXs, jvmSession) => f(wrap(jvmXs), (0, exports.wrapSession)(jvmSession))._underlying;
      exports.underlyingJvmXToXWithSessionToSession = underlyingJvmXToXWithSessionToSession;
      var underlyingJvmXToXWithBiSessionToSession = (f, wrap) => (jvmXs, jvmMain, jvmForked) => f(wrap(jvmXs), (0, exports.wrapSession)(jvmMain), (0, exports.wrapSession)(jvmForked))._underlying;
  ...
  var require_assertions = __commonJS({
    "node_modules/@gatling.io/core/target/assertions.js"(exports) {
      ...
      var jvm_types_1 = require_jvm_types();
      var global2 = () => wrapAssertionWithPath(jvm_types_1.CoreDsl.global());
  ...
  var require_validate = __commonJS({
    "node_modules/@gatling.io/core/target/checks/validate.js"(exports) {
      ...
      var wrapCheckBuilderValidate = (_underlying) => ({
        ...
        in: (expectedOrFunction, ...additionalValues) => (0, final_1.wrapCheckBuilderFinal)(typeof expectedOrFunction === "function" ? _underlying.in((0, session_1.underlyingSessionTo)(expectedOrFunction)) : _underlying.in([expectedOrFunction, ...additionalValues])),
  ...
  // node_modules/@gatling.io/core/target/dummy.js
  var require_dummy = __commonJS({
    "node_modules/@gatling.io/core/target/dummy.js"(exports) {
      "use strict";
      init_globals();
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      var jvm_types_1 = require_jvm_types();
      var session_1 = require_session();
      var wrapDummyBuilder = (_underlying) => ({
        _underlying,
        withSuccess: (newSuccess) => wrapDummyBuilder(typeof newSuccess === "function" ? _underlying.withSuccess((0, session_1.underlyingSessionTo)(newSuccess)) : typeof newSuccess === "string" ? _underlying.withSuccess(newSuccess) : _underlying.withSuccess(newSuccess)),
        withSessionUpdate: (f) => wrapDummyBuilder(_underlying.withSessionUpdate((0, session_1.underlyingSessionTransform)(f)))
      });
      var dummy = (actionName, responseTime) => {
  ...
  var require_feeders = __commonJS({
    "node_modules/@gatling.io/core/target/feeders.js"(exports) {
      ...
      var csv = (filePath, quoteChar) => (0, exports.wrapFileBasedFeederBuilder)(quoteChar !== void 0 ? jvm_types_1.CoreDsl.csv(filePath, quoteChar) : jvm_types_1.CoreDsl.csv(filePath));
      exports.csv = csv;
      var ssv = (filePath, quoteChar) => (0, exports.wrapFileBasedFeederBuilder)(quoteChar !== void 0 ? jvm_types_1.CoreDsl.ssv(filePath, quoteChar) : jvm_types_1.CoreDsl.ssv(filePath));
      exports.ssv = ssv;
      var tsv = (filePath, quoteChar) => (0, exports.wrapFileBasedFeederBuilder)(quoteChar !== void 0 ? jvm_types_1.CoreDsl.tsv(filePath, quoteChar) : jvm_types_1.CoreDsl.tsv(filePath));
      exports.tsv = tsv;
      var separatedValues = (filePath, separator, quoteChar) => (0, exports.wrapFileBasedFeederBuilder)(quoteChar !== void 0 ? jvm_types_1.CoreDsl.separatedValues(filePath, separator, quoteChar) : jvm_types_1.CoreDsl.separatedValues(filePath, separator));
  ...
  var require_openInjection = __commonJS({
    "node_modules/@gatling.io/core/target/openInjection.js"(exports) {
      ...
      var rampUsers = (users) => wrapOpenInjectionStepRamp(jvm_types_1.CoreDsl.rampUsers(users));
      ...
      var atOnceUsers2 = (users) => wrapOpenInjectionStep(jvm_types_1.CoreDsl.atOnceUsers(users));
      exports.atOnceUsers = atOnceUsers2;
  ...
  var require_parameters = __commonJS({
    "node_modules/@gatling.io/core/target/parameters.js"(exports) {
      ...
      var jvm_types_1 = require_jvm_types();
      var getParameter2 = (key, defaultValue) => getOrElse(jvm_types_1.System.getProperty(key), defaultValue);
      exports.getParameter = getParameter2;
  ...
  var require_target = __commonJS({
    "node_modules/@gatling.io/core/target/index.js"(exports) {
      ...
      Object.defineProperty(exports, "asByteArrayMap", { enumerable: true, get: function() {
        return byteArrays_1.asByteArrayMap;
      } });
      ...
      Object.defineProperty(exports, "dummy", { enumerable: true, get: function() {
        return dummy_1.dummy;
      } });
  ...
  var require_request2 = __commonJS({
    "node_modules/@gatling.io/http/target/request/index.js"(exports) {
      ...
      var wrapHttpRequestActionBuilder = (_underlying) => ({
        ...
        checkIf: (condition) => (0, core_1.wrapCondition)(typeof condition === "string" ? _underlying.checkIf(condition) : _underlying.checkIf((0, core_1.underlyingSessionTo)(condition)), exports.wrapHttpRequestActionBuilder),
  ...
  var require_status = __commonJS({
    "node_modules/@gatling.io/http/target/response/status.js"(exports) {
      ...
      var HttpResponseStatus = class _HttpResponseStatus {
        code;
        reasonPhrase;
        /**
         * 100 Continue
         */
        static CONTINUE = new _HttpResponseStatus(100, "Continue");
        /**
         * 101 Switching Protocols
         */
        static SWITCHING_PROTOCOLS = new _HttpResponseStatus(101, "Switching Protocols");
        /**
         * 102 Processing (WebDAV, RFC2518)
         */
        static PROCESSING = new _HttpResponseStatus(102, "Processing");
        /**
         * 103 Early Hints (RFC 8297)
         */
        static EARLY_HINTS = new _HttpResponseStatus(103, "Early Hints");
        /**
         * 200 OK
         */
        static OK = new _HttpResponseStatus(200, "OK");
        /**
         * 201 Created
         */
        static CREATED = new _HttpResponseStatus(201, "Created");
        /**
         * 202 Accepted
         */
        static ACCEPTED = new _HttpResponseStatus(202, "Accepted");
        /**
         * 203 Non-Authoritative Information (since HTTP/1.1)
         */
        static NON_AUTHORITATIVE_INFORMATION = new _HttpResponseStatus(203, "Non-Authoritative Information");
        /**
         * 204 No Content
         */
        static NO_CONTENT = new _HttpResponseStatus(204, "No Content");
        /**
         * 205 Reset Content
         */
        static RESET_CONTENT = new _HttpResponseStatus(205, "Reset Content");
        /**
         * 206 Partial Content
         */
        static PARTIAL_CONTENT = new _HttpResponseStatus(206, "Partial Content");
        /**
         * 207 Multi-Status (WebDAV, RFC2518)
         */
        static MULTI_STATUS = new _HttpResponseStatus(207, "Multi-Status");
        /**
         * 300 Multiple Choices
         */
        static MULTIPLE_CHOICES = new _HttpResponseStatus(300, "Multiple Choices");
        /**
         * 301 Moved Permanently
         */
        static MOVED_PERMANENTLY = new _HttpResponseStatus(301, "Moved Permanently");
        /**
         * 302 Found
         */
        static FOUND = new _HttpResponseStatus(302, "Found");
        /**
         * 303 See Other (since HTTP/1.1)
         */
        static SEE_OTHER = new _HttpResponseStatus(303, "See Other");
        /**
         * 304 Not Modified
         */
        static NOT_MODIFIED = new _HttpResponseStatus(304, "Not Modified");
        /**
         * 305 Use Proxy (since HTTP/1.1)
         */
        static USE_PROXY = new _HttpResponseStatus(305, "Use Proxy");
        /**
         * 307 Temporary Redirect (since HTTP/1.1)
         */
        static TEMPORARY_REDIRECT = new _HttpResponseStatus(307, "Temporary Redirect");
        /**
         * 308 Permanent Redirect (RFC7538)
         */
        static PERMANENT_REDIRECT = new _HttpResponseStatus(308, "Permanent Redirect");
        /**
         * 400 Bad Request
         */
        static BAD_REQUEST = new _HttpResponseStatus(400, "Bad Request");
        /**
         * 401 Unauthorized
         */
        static UNAUTHORIZED = new _HttpResponseStatus(401, "Unauthorized");
        /**
         * 402 Payment Required
         */
        static PAYMENT_REQUIRED = new _HttpResponseStatus(402, "Payment Required");
        /**
         * 403 Forbidden
         */
        static FORBIDDEN = new _HttpResponseStatus(403, "Forbidden");
        /**
         * 404 Not Found
         */
        static NOT_FOUND = new _HttpResponseStatus(404, "Not Found");
        /**
         * 405 Method Not Allowed
         */
        static METHOD_NOT_ALLOWED = new _HttpResponseStatus(405, "Method Not Allowed");
        /**
         * 406 Not Acceptable
         */
        static NOT_ACCEPTABLE = new _HttpResponseStatus(406, "Not Acceptable");
        /**
         * 407 Proxy Authentication Required
         */
        static PROXY_AUTHENTICATION_REQUIRED = new _HttpResponseStatus(407, "Proxy Authentication Required");
        /**
         * 408 Request Timeout
         */
        static REQUEST_TIMEOUT = new _HttpResponseStatus(408, "Request Timeout");
        /**
         * 409 Conflict
         */
        static CONFLICT = new _HttpResponseStatus(409, "Conflict");
        /**
         * 410 Gone
         */
        static GONE = new _HttpResponseStatus(410, "Gone");
        /**
         * 411 Length Required
         */
        static LENGTH_REQUIRED = new _HttpResponseStatus(411, "Length Required");
        /**
         * 412 Precondition Failed
         */
        static PRECONDITION_FAILED = new _HttpResponseStatus(412, "Precondition Failed");
        /**
         * 413 Request Entity Too Large
         */
        static REQUEST_ENTITY_TOO_LARGE = new _HttpResponseStatus(413, "Request Entity Too Large");
        /**
         * 414 Request-URI Too Long
         */
        static REQUEST_URI_TOO_LONG = new _HttpResponseStatus(414, "Request-URI Too Long");
        /**
         * 415 Unsupported Media Type
         */
        static UNSUPPORTED_MEDIA_TYPE = new _HttpResponseStatus(415, "Unsupported Media Type");
        /**
         * 416 Requested Range Not Satisfiable
         */
        static REQUESTED_RANGE_NOT_SATISFIABLE = new _HttpResponseStatus(416, "Requested Range Not Satisfiable");
        /**
         * 417 Expectation Failed
         */
        static EXPECTATION_FAILED = new _HttpResponseStatus(417, "Expectation Failed");
        /**
         * 421 Misdirected Request
         *
         * @see <a href="https://tools.ietf.org/html/rfc7540#section-9.1.2">421 (Misdirected Request) Status Code</a>
         */
        static MISDIRECTED_REQUEST = new _HttpResponseStatus(421, "Misdirected Request");
        /**
         * 422 Unprocessable Entity (WebDAV, RFC4918)
         */
        static UNPROCESSABLE_ENTITY = new _HttpResponseStatus(422, "Unprocessable Entity");
        /**
         * 423 Locked (WebDAV, RFC4918)
         */
        static LOCKED = new _HttpResponseStatus(423, "Locked");
        /**
         * 424 Failed Dependency (WebDAV, RFC4918)
         */
        static FAILED_DEPENDENCY = new _HttpResponseStatus(424, "Failed Dependency");
        /**
         * 425 Unordered Collection (WebDAV, RFC3648)
         */
        static UNORDERED_COLLECTION = new _HttpResponseStatus(425, "Unordered Collection");
        /**
         * 426 Upgrade Required (RFC2817)
         */
        static UPGRADE_REQUIRED = new _HttpResponseStatus(426, "Upgrade Required");
        /**
         * 428 Precondition Required (RFC6585)
         */
        static PRECONDITION_REQUIRED = new _HttpResponseStatus(428, "Precondition Required");
        /**
         * 429 Too Many Requests (RFC6585)
         */
        static TOO_MANY_REQUESTS = new _HttpResponseStatus(429, "Too Many Requests");
        /**
         * 431 Request Header Fields Too Large (RFC6585)
         */
        static REQUEST_HEADER_FIELDS_TOO_LARGE = new _HttpResponseStatus(431, "Request Header Fields Too Large");
        /**
         * 500 Internal Server Error
         */
        static INTERNAL_SERVER_ERROR = new _HttpResponseStatus(500, "Internal Server Error");
        /**
         * 501 Not Implemented
         */
        static NOT_IMPLEMENTED = new _HttpResponseStatus(501, "Not Implemented");
        /**
         * 502 Bad Gateway
         */
        static BAD_GATEWAY = new _HttpResponseStatus(502, "Bad Gateway");
        /**
         * 503 Service Unavailable
         */
        static SERVICE_UNAVAILABLE = new _HttpResponseStatus(503, "Service Unavailable");
        /**
         * 504 Gateway Timeout
         */
        static GATEWAY_TIMEOUT = new _HttpResponseStatus(504, "Gateway Timeout");
        /**
         * 505 HTTP Version Not Supported
         */
        static HTTP_VERSION_NOT_SUPPORTED = new _HttpResponseStatus(505, "HTTP Version Not Supported");
        /**
         * 506 Variant Also Negotiates (RFC2295)
         */
        static VARIANT_ALSO_NEGOTIATES = new _HttpResponseStatus(506, "Variant Also Negotiates");
        /**
         * 507 Insufficient Storage (WebDAV, RFC4918)
         */
        static INSUFFICIENT_STORAGE = new _HttpResponseStatus(507, "Insufficient Storage");
        /**
         * 510 Not Extended (RFC2774)
         */
        static NOT_EXTENDED = new _HttpResponseStatus(510, "Not Extended");
        /**
         * 511 Network Authentication Required (RFC6585)
         */
        static NETWORK_AUTHENTICATION_REQUIRED = new _HttpResponseStatus(511, "Network Authentication Required");
  ...
  var require_cookies = __commonJS({
    "node_modules/@gatling.io/http/target/cookies.js"(exports) {
      ...
      var wrapGetCookie = (_underlying) => ({
        _underlying,
        withDomain: (domain) => wrapGetCookie(typeof domain === "function" ? _underlying.withDomain((0, core_1.underlyingSessionTo)(domain)) : _underlying.withDomain(domain)),
  ...
  var require_proxy = __commonJS({
    "node_modules/@gatling.io/http/target/proxy.js"(exports) {
      ...
      var wrapProxy = (_underlying) => ({
        ...
        credentials: (username, password) => wrapProxy(typeof username === "function" ? typeof password === "function" ? _underlying.credentials((0, core_1.underlyingSessionTo)(username), (0, core_1.underlyingSessionTo)(password)) : _underlying.credentials((0, core_1.underlyingSessionTo)(username), password) : typeof password === "function" ? _underlying.credentials(username, (0, core_1.underlyingSessionTo)(password)) : _underlying.credentials(username, password)),
        connectHeader: (name, value) => wrapProxy(typeof value === "function" ? _underlying.connectHeader(name, (0, core_1.underlyingSessionTo)(value)) : _underlying.connectHeader(name, value)),
  ...
  // node_modules/@gatling.io/http/target/ws.js
  var require_ws = __commonJS({
    "node_modules/@gatling.io/http/target/ws.js"(exports) {
      "use strict";
      init_globals();
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      var jvmWsPrefix = jvm_types_1.Ws$Prefix.INSTANCE;
      var wsPrefix = {
        checkBinaryMessage: (name) => wrapWsFrameCheckBinary(typeof name === "function" ? jvmWsPrefix.checkBinaryMessage((0, core_1.underlyingSessionTo)(name)) : jvmWsPrefix.checkBinaryMessage(name)),
        checkTextMessage: (name) => wrapWsFrameCheckText(typeof name === "function" ? jvmWsPrefix.checkTextMessage((0, core_1.underlyingSessionTo)(name)) : jvmWsPrefix.checkTextMessage(name)),
      ...
      var wsAwaitActionBuilderImpl = (jvmBuilder, wrap) => ({
        await: (timeout) => wrapWsAwaitActionBuilderOn((0, core_1.isDuration)(timeout) ? jvmBuilder.await((0, core_1.toJvmDuration)(timeout)) : typeof timeout === "function" ? jvmBuilder.await((0, core_1.underlyingSessionToDuration)(timeout)) : jvmBuilder.await(timeout), wrap)
      });
      var wrapWsAwaitActionBuilderOn = (jvmOn, wrap) => ({
        on: (...checks) => wrap(jvmOn.on(checks.map((c) => c._underlying)))
      });
      var wrapWsConnectActionBuilder = (_underlying) => ({
        _underlying,
      ...
      var wrapWsFrameCheckBinaryUntypedCondition = (_underlying) => ({
        then: (...thenChecks) => wrapWsFrameCheckBinary(_underlying.then(thenChecks.map((cb) => cb._underlying)))
      });
      var wrapWsFrameCheckBinaryTypedCondition = (_underlying) => ({
        then: (...thenChecks) => wrapWsFrameCheckBinary(_underlying.then(thenChecks.map((cb) => cb._underlying)))
      });
      var wrapWsFrameCheckText = (_underlying) => ({
        _underlying,
      ...
      var wrapWsFrameCheckTextUntypedCondition = (_underlying) => ({
        then: (...thenChecks) => wrapWsFrameCheckText(_underlying.then(thenChecks.map((cb) => cb._underlying)))
      });
      var wrapWsFrameCheckTextTypedCondition = (_underlying) => ({
        then: (...thenChecks) => wrapWsFrameCheckText(_underlying.then(thenChecks.map((cb) => cb._underlying)))
      });
      var isWsInboundMessageBinary = (message) => typeof message.message() !== "string";
      exports.isWsInboundMessageBinary = isWsInboundMessageBinary;
      var isWsInboundMessageText = (message) => typeof message.message() === "string";
      ...
      var wrapWs = (jvmWs) => ({
        ...
        sendBytes: (bytes) => wrapWsSendBinaryActionBuilder(typeof bytes === "function" ? jvmWs.sendBytes((0, core_1.underlyingSessionTo)(bytes)) : typeof bytes === "string" ? jvmWs.sendBytes(bytes) : jvmWs.sendBytes(bytes)),
        close: () => (0, core_1.wrapActionBuilder)(jvmWs.close())
      });
      var wsApply = (name, wsName) => {
        const jvmWs = wsName === void 0 ? jvm_types_1.HttpDsl.ws(name) : jvm_types_1.HttpDsl.ws(name, wsName);
        return wrapWs(jvmWs);
      };
  ...
  // node_modules/@gatling.io/http/target/sse.js
  var require_sse = __commonJS({
    "node_modules/@gatling.io/http/target/sse.js"(exports) {
      "use strict";
      init_globals();
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.sse = void 0;
      ...
      var jvm_types_1 = require_jvm_types();
      var request_1 = require_request2();
      var wrapUntypedCondition = (_underlying) => ({
        then: (...thenChecks) => wrapSseMessageCheck(_underlying.then(thenChecks.map((cb) => cb._underlying)))
      });
      var wrapTypedCondition = (_underlying) => ({
        then: (...thenChecks) => wrapSseMessageCheck(_underlying.then(thenChecks.map((cb) => cb._underlying)))
      });
      var wrapSseMessageCheck = (_underlying) => ({
        _underlying,
      ...
      var wrapSseAwaitActionBuilderOn = (jvmOn, wrap) => ({
        on: (...checks) => wrap(jvmOn.on(checks.map((c) => c._underlying)))
      });
      var sseAwaitActionBuilderImpl = (jvmBuilder, wrap) => ({
        await: (timeout) => {
      ...
      var wrapSseConnectActionBuilder = (_underlying) => ({
        _underlying,
      ...
      var wrapSseSetCheckActionBuilder = (_underlying) => ({
        _underlying,
      ...
      var jvmSsePrefix = jvm_types_1.Sse$Prefix.INSTANCE;
      var ssePrefix = {
  ...
  var require_target2 = __commonJS({
    "node_modules/@gatling.io/http/target/index.js"(exports) {
      ...
      __exportStar(require_sse(), exports);
      ...
      var wrapHttp = (jvmHttp) => ({
        ...
        httpRequest: (method, url) => (0, request_1.wrapHttpRequestActionBuilder)(typeof method === "function" ? typeof url === "function" ? jvmHttp.httpRequest((0, core_2.underlyingSessionTo)(method), (0, core_2.underlyingSessionTo)(url)) : jvmHttp.httpRequest((0, core_2.underlyingSessionTo)(method), url) : typeof url === "function" ? jvmHttp.httpRequest(method, (0, core_2.underlyingSessionTo)(url)) : jvmHttp.httpRequest(method, url))
      });
      var httpApply = (name) => {
      ...
      var httpConcurrentRequests = (head, ...tail) => (0, core_1.wrapActionBuilder)(jvm_types_1.HttpDsl.httpConcurrentRequests(head._underlying, ...tail.map((b) => b._underlying)));
  ...
  var basicSimulation_gatling_default = (0, import_core.simulation)((setUp) => {
    const httpProtocol = import_http.http.baseUrl("https://slotomania.com").acceptHeader("application/json");
    const scenario_for_sm = (0, import_core.scenario)("Scenario for Slotomania").exec((0, import_http.http)("Session").get("/").check((0, import_http.status)().is(200)));
    const assertion = (0, import_core.global)().successfulRequests().count().gt(100);
    setUp(scenario_for_sm.injectOpen((0, import_core.atOnceUsers)(10))).assertions(assertion).protocols(httpProtocol);
  });
